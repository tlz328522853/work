        ...
        this.$get = ['$document', '$templateCache', '$compile', '$q', '$http', '$rootScope', '$timeout', '$window', '$controller', '$injector',
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay" ></div><div class="ngdialog-content" style="width:'+ options.width +'"  role="document">' + template + '</div>' :
                                '<div class="ngdialog-content" style="width:'+ options.width +'"  role="document">' + template + '</div>'));
                        ...
                        function loadTemplate (tmpl) {
                            if (!tmpl) {
                                return '<div class="dialog-contents">'+
                                'Some message'+
                    ...
                    openCustomConfirm: function (opts) {
                    	
                    	opts.templateUrl = 'platform/template/delete.html';
                    	opts.className = 'ngdialog-theme-plain';
                    	opts.scope.title = opts.title;
                    	opts.scope.message = opts.message;
                    	angular.element("#determine").focus();
                        var defer = $q.defer();
                        var options = angular.copy(defaults);
                        ...
                        options.scope.enter=function(e){
                        	 var $dialog = $el(document.getElementById(openResult.id));
                    		var keycode = window.event?e.keyCode:e.which;
                            if(keycode!=13){
                               return;
                            }
                            angular.element("#determine").click();
                    ...
                    alertCustomConfirm: function (opts) {
                    	
                    	opts.templateUrl = 'platform/template/alert.html';
                    	opts.className = 'ngdialog-theme-plain';
                    	opts.scope.title = opts.title;
                    	opts.scope.message = opts.message;
                    	angular.element("#determine").focus();
