...
.directive('fileUpload',['FileUploader','$rootScope','$cookieStore','notifications',function(FileUploader,rootScope,cookieStore,notifications){
	return{
		restrict:'EAMC',
	    templateUrl:'platform/template/fileUpload.html',
	    replace:true,
	    scope:{
	    	files:'=files',
	    	imgSrc:'=imgSrc',
