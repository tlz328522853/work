(function (root, factory) {
	...
	module.directive('notificationsBar', ['notificationsConfig', '$timeout','$rootScope', function (notificationsConfig, $timeout,$rootScope) {
		return {
			restrict: 'EA',
			...
			link: function (scope) {
				...
				var notificationHandler = function (event, data, type, animation) {
					...
					if (typeof data === 'object' && data != null && data.message != null) {
